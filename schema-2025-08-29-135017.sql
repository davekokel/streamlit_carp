...
CREATE OR REPLACE FUNCTION "public"."set_fish_code_per_year"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  yr       integer;
...
CREATE OR REPLACE TRIGGER "trg_set_fish_code_per_year" BEFORE INSERT ON "public"."fish" FOR EACH ROW WHEN (("new"."fish_code" IS NULL)) EXECUTE FUNCTION "public"."set_fish_code_per_year"();
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."fish_year_counters" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."fish_year_counters" TO "authenticated";
