...
\restrict 1jx9nLbtGHhCFGoXjn9fFrH8agCuWhoc3vbyp7s30JVKxFzDaIvWAYUjbCBKCe5
...
CREATE TABLE public.tanks (
    ...
    CONSTRAINT tanks_tank_code_format_chk CHECK ((tank_code ~ '^(NURSERY|ADULT)-tank-[0-9]{2}-[0-9]{4}$'::text))
);
...
\unrestrict 1jx9nLbtGHhCFGoXjn9fFrH8agCuWhoc3vbyp7s30JVKxFzDaIvWAYUjbCBKCe5
