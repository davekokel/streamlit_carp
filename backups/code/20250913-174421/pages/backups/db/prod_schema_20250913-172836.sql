...
\restrict jASJSNk0CERPbj6LYGeTkU8O0Vg9UQfOoNGaDPjWUBQAFyawZE8UZoHfgk19Ii7
...
--
-- Name: alloc_tank_code_for_site_yy(integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.alloc_tank_code_for_site_yy(y_in integer, s text) RETURNS text
    LANGUAGE plpgsql
    AS $$ DECLARE vsite public.site_enum; BEGIN vsite := upper(btrim(s))::public.site_enum; RETURN public.alloc_tank_code_for_site_yy(y_in, vsite); END $$;


ALTER FUNCTION public.alloc_tank_code_for_site_yy(y_in integer, s text) OWNER TO postgres;
...
--
-- Name: tanks_set_tank_code_site_yy(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.tanks_set_tank_code_site_yy() RETURNS trigger
    LANGUAGE plpgsql
    AS $$ BEGIN IF (NEW.tank_code IS NULL OR btrim(NEW.tank_code)='') AND NEW.site_code IS NOT NULL THEN NEW.tank_code := public.alloc_tank_code_for_site_yy(EXTRACT(YEAR FROM COALESCE(NEW.created_at, now()))::int, NEW.site_code); END IF; IF (NEW.code IS NULL OR btrim(NEW.code)='') AND NEW.tank_code IS NOT NULL THEN NEW.code := NEW.tank_code; END IF; RETURN NEW; END $$;


ALTER FUNCTION public.tanks_set_tank_code_site_yy() OWNER TO postgres;
...
--
-- Name: tanks tanks_set_code; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER tanks_set_code BEFORE INSERT ON public.tanks FOR EACH ROW EXECUTE FUNCTION public.set_code_if_null('TK', 'public.tanks_code_seq');


--
-- Name: tanks tanks_set_tank_code_before_insert; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER tanks_set_tank_code_before_insert BEFORE INSERT ON public.tanks FOR EACH ROW EXECUTE FUNCTION public.tanks_set_tank_code_site_yy();
...
--
-- Name: FUNCTION alloc_tank_code_for_site_yy(y_in integer, s text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.alloc_tank_code_for_site_yy(y_in integer, s text) TO anon;
GRANT ALL ON FUNCTION public.alloc_tank_code_for_site_yy(y_in integer, s text) TO authenticated;
GRANT ALL ON FUNCTION public.alloc_tank_code_for_site_yy(y_in integer, s text) TO service_role;
...
--
-- Name: FUNCTION tanks_set_tank_code_site_yy(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.tanks_set_tank_code_site_yy() TO anon;
GRANT ALL ON FUNCTION public.tanks_set_tank_code_site_yy() TO authenticated;
GRANT ALL ON FUNCTION public.tanks_set_tank_code_site_yy() TO service_role;
...
\unrestrict jASJSNk0CERPbj6LYGeTkU8O0Vg9UQfOoNGaDPjWUBQAFyawZE8UZoHfgk19Ii7
